...
exports.genre_delete_post = asyncHandler(async (req, res, next) => {
    ...
    if (allBooksInGenre.length > 0) {
        //There are still books that needs to be deleted first.Render in same way as for GET route.
        res.render("genre_delete", {
            title: "Delete Genre",
            genre: genre,
            genre_books: allBooksInGenre
        ...
        //There are no books associated with this genre so delete the object and redirect to list of all genres
